...
# detect_group.py contains the same code as detect.py,
# with additional functionality to group similar detections (bounding boxes) together
# as a single detection (single bounding box).
# Overlapped bounding boxes are merged together, but label and confidence values won't be included.
